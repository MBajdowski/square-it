            ...
            <View style={styles.scrollContainer}>
                <ScrollView showsVerticalScrollIndicator={false}>
                    ...
                    <InstructionComponent
                        ...
                        images={[require("../../assets/instruction/_plusTwoPairs.png"), require("../../assets/instruction/plusTwoPairsMerged.png")]}
                    />
                    <InstructionComponent
                        text={'Plus tile will become grey tile if no pairs will be find'}
                        images={[require("../../assets/instruction/_plusNoPairs.png"), require("../../assets/instruction/plusNoPairsGrey.png")]}
                    />
                    <InstructionComponent
                    ...
                    <InstructionComponent
                        ...
                        images={[require("../../assets/instruction/_multiCombo.png"), require("../../assets/instruction/multiComboMerged.png")]}
                    />
                </ScrollView>
            </View>
        </View>
